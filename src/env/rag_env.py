...
class RAGEnv(gym.Env):
    def __init__(self, dataset: RAGDataset, rewarder: Rewarder, embedding_model: str, llm: str, num_top_k_values:int = 5):
        super().__init__()
        ...
        self.action_space = gym.spaces.Discrete(num_top_k_values)  # top_k values: {1, 3, 5, 10, 20}
